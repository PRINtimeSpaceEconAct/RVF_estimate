...
#1984
pictureMoranScatterplot(dfPooled=dfPooled, df=df.1984, year="1984", shp_comm=shp_comm_2001,  shp_sll=shp_SLL_2001, scatterPlot=TRUE, map=FALSE, typeCities="metro")
# dev.copy2eps (file=paste("moranScatterplot_",1984,".eps",sep=""))

# Figure 3 (b) ----

#2019
pictureMoranScatterplot(dfPooled=dfPooled, df=df.2019, year="2019", shp_comm=shp_comm_2019,  shp_sll=shp_SLL_2011, scatterPlot=TRUE, map=FALSE, typeCities="metro")
